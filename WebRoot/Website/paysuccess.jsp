            ...
            <form action="#" method="post">
                <div class="form-group">
                    <div class="input-group">
                        <img src="images/success.png" class=" img-responsive center-block" alt="success" style="width: 100px;height: 100px;">
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <h1 class="col-md-12 col-sm-12 text-center tab-h1" style="text-align: center;display: inline-block;">支付成功</h1>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <h1 class="col-md-12 col-sm-12 text-center tab-h1" style="text-align: center;display: inline-block;">请核对个人信息</h1>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <h2 class="col-md-12 col-sm-12 text-center tab-h2" style="text-align: center;display: inline-block;margin-top: 30px">报名资料已提交,之后会有工作人员与您取得联系。</br>（如有信息错误请及时反馈，联系QQ：1952219401，网站页面导航下设有报名信息查询，可再次查询报名信息。）</h2>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <h1 class="col-md-12 col-sm-12 text-center tab-h1" style="text-align: center;display: inline-block;margin-top: 30px">
                            <a href="index.html" class="backa">返回首页</a>
                        </h1>
                    </div>
                </div>
            </form>
